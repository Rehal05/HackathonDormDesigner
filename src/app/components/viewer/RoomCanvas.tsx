...
import { useFurnitureCollision, type DynamicFurnitureItem } from "../../context/FurnitureContext";
...
export function RoomCanvas({
  ...
  const { dynamicFurniture, placementItem, updatePlacement, rotatePlacement, confirmPlacement, cancelPlacement, removalMode, selectedForRemoval } = useFurnitureCollision();
