...
export const furniture: FurnitureItem[] = [
  ...
  //{ id: "potted_plant", name: "Potted Plant", modelType: "potted_plant", category: "storage", price: 29, imageUrl: "", defaultDimensions: { width: 2, height: 2, depth: 2 } },
    ...
    { id: "ww_bed", name: "Mini Fridge", modelType: "ww_bed", category: "bed", price: 289, imageUrl: "", defaultDimensions: { width: 7, height: 3, depth: 3 } },
  { id: "loft_bed", name: "Basketball", modelType: "bed", category: "bed", price: 259, imageUrl: "", defaultDimensions: { width: 4, height: 5, depth: 2.5 } },
